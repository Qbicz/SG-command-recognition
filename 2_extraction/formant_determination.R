...
# 
# Zwraca wektor z trzema wartosciami (czestotliwosci
# formantow)
# 
# Przed pierwszym uzyciem wykonaj nastepujace komendy:
#
...
# formant_determination(wave_input,wave_rate)
#
#output:
...
formant_determination <- function(wave_input, wave_rate){
